...
{
    public class TagSelectionUI : PopupWindowContent
    {
        ...
        public override void OnGUI(Rect rect)
        {
            ...
            {
                _assetInfo.ForEach(info => AssetInventory.AddAssetTag(info, _newTag));
                _newTag = "";
            }
            ...
            if (_tags != null)
            {
                ...
                else
                {
                    ...
                    foreach (Tag tag in _tags)
                    {
                        ...
                        GUILayout.BeginHorizontal();
                        GUILayout.Space(8);
                        UIStyles.DrawTag(tag.Name, tag.GetColor(), () => { _assetInfo.ForEach(info => AssetInventory.AddAssetTag(info, tag.Name)); }, UIStyles.TagStyle.Add);
                        GUILayout.EndHorizontal();
                    }
                    if (shownTags == 0)
                    {
